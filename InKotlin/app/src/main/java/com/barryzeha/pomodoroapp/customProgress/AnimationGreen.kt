package com.barryzeha.pomodoroapp.customProgress
...
class AnimationGreen @JvmOverloads constructor(
    ...
    //filling the animated green circle
    private val paintAnimationGreen = Paint().apply {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        drawLoadingAnimationGreen(canvas!!)
    }

    private fun drawLoadingAnimationGreen(canvas: Canvas){
        val percentageToFill = getCurrentPercentageToFill()
        //animating the filled button
        canvas.drawArc(ovalSpace, 270f, percentageToFill, false, paintAnimationGreen)
        invalidate()
    }
